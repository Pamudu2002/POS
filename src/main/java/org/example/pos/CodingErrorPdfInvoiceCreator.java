...
public class CodingErrorPdfInvoiceCreator {
    ...
    public void createProduct(List<Product> productList) {
        ...
        {
            double total=product.getPriceperpeice();
    ...
    public double getTotalSum(List<Product> productList) {
        return  (double) productList.stream().mapToDouble((p)-> (double) (p.getPriceperpeice())).sum();
    }
